 ...
 * @abstract
 */
GibbonAdapter.prototype.addPermissions = function () {
    throw new Error(INHERITANCE_ERROR);
};
 ...
 * @abstract
 */
GibbonAdapter.prototype.findUsersByPermission = function () {
    throw new Error(INHERITANCE_ERROR);
};
 ...
 * @abstract
 */
GibbonAdapter.prototype.findUsersByGroup = function () {
    throw new Error(INHERITANCE_ERROR);
};
 ...
 */
GibbonAdapter.prototype.findGroupsByPermission = function () {
    throw new Error(INHERITANCE_ERROR);
};
...
/**
 * Find array of groups
 * @abstract
 */
GibbonAdapter.prototype.findGroups = function () {
    throw new Error(INHERITANCE_ERROR);
};
